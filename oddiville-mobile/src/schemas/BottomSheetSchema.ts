...
const detailItem = z.object({
  label: z.string(),
  value: z.string(),
  icon: z.enum(['database', 'user', 'location', 'calendar-check', 'user-square', 'truck', 'truck-num', 'clock', 'package', 'chamber', 'male', 'female', 'money', 'box', 'lane', 'color-swatch', 'trash', 'star', 'calendar-year']),
});
...
const TableSection = z.object({
  ...
  data: z.array(
    z.object({
      ...
      tableHeader: z.array(z.object({
        label: z.string(),
        key: z.string(),
      })),
      tableBody: z.array(z.record(z.string(), z.union([z.string(), z.number()])))
    })
  )
});
...
const SearchSection = z.object({
  ...
  data: z.object({
    ...
    searchType: z.enum(["city", "state", "country", "add-raw-material", "add-product", "add-package"]).optional(),
  })
});
...
const OptionListSection = z.object({
  ...
  data: z.object({
    ...
    key: z.union([
      z.enum(["user-action", "vendor-action",  "supervisor-production", "product-package"]),
      z.string()
    ]).optional()
  }),
});
...
export const OrderReadyBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [HeaderSection, DataSection, ProductListSection])),
  buttons: z.array(ButtonSchema).optional(),
});

export const PackageComesToEndBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [HeaderSection, TitleWithTagSection, AddressSection, InputSection])),
  buttons: z.array(ButtonSchema).optional(),
});

export const VerifyMaterialBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [HeaderSection, FullWidthImageSection, RatingSection, DataAccordianSection])),
  buttons: z.array(ButtonSchema).optional(),
});

export const ProductionStartedBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [HeaderSection, FullWidthImageSection, RatingSection, DataAccordianSection, FullWidthSliderSection])),
  buttons: z.array(ButtonSchema).optional(),
});
...
export const WorkerBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [HeaderSection, DataSection, TableSection])),
});

export const OrderShippedBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [HeaderSection, ProductDtailsSection, TruckFullDetailsSection, ProductListAccoridanSection])),
  buttons: z.array(ButtonSchema).optional(),
});
...
export const AddRawMaterialBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [TitleWithDetailsCrossSection, SearchSection, ProductCardSection])),
  buttons: z.array(ButtonSchema).optional(),
});

export const AddProductBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [TitleWithDetailsCrossSection, SearchSection, OptionListSection])),
});

export const AddVendorBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [TitleWithDetailsCrossSection, SearchSection, TitleCheckCountSection, VendorCardSection])),
  buttons: z.array(ButtonSchema).optional(),
});
...
export const LaneOccupiedBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [HeaderSection, DataSection, FullWidthImageSection])),
});

export const CancelOrderBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [HeaderSection, DescriptionSection, ProductDtailsSection, TruckFullDetailsSection, ProductListAccoridanSection])),
});

export const FilterBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [TitleWithCheckboxSection, OptionListSection])),
  buttons: z.array(ButtonSchema).optional(),
});

export const SupervisorProductionBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [TitleWithDetailsCrossSection, SelectSection, InputWithSelectSection, AddonInputSection])),
  buttons: z.array(ButtonSchema).optional(),
});
...
export const FillPackageBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [TitleWithDetailsCrossSection, InputSection])),
  buttons: z.array(ButtonSchema).optional()
});
...
export const AddPackageBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [TitleWithDetailsCrossSection, InputSection, InputWithSelectSection, SelectGroupSection])),
  buttons: z.array(ButtonSchema).optional()
});
...
export const CountryBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [HeaderSection, SearchSection, IconTitleWithHeadingSection])),
});

export const StateBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [HeaderSection, SearchSection, OptionListSection])),
});
...
export const ChoosePackageBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [TitleWithDetailsCrossSection, SearchSection, PackagingSizeSection])),
  buttons: z.array(ButtonSchema).optional()
});

export const UpcomingOrderBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [TitleWithDetailsCrossSection, DataSection, ProductListSection])),
  buttons: z.array(ButtonSchema).optional()
});
...
export const InProgressOrderBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [TitleWithDetailsCrossSection, ProductDtailsSection, TruckFullDetailsSection, ProductListAccoridanSection])),
  buttons: z.array(ButtonSchema).optional()
});

export const ImagePreviewBottomSheetConfigSchema = z.object({
  sections: z.array(z.discriminatedUnion('type', [TitleWithDetailsCrossSection, ImagePreviewSection, FullWidthSliderSection])),
});
...
export type PackageComesToEndBottomSheetConfig = z.infer<typeof PackageComesToEndBottomSheetConfigSchema>;
export type VerifyMaterialBottomSheetConfig = z.infer<typeof VerifyMaterialBottomSheetConfigSchema>;
export type ProductionStartedBottomSheetConfig = z.infer<typeof ProductionStartedBottomSheetConfigSchema>;
export type RawMaterialBottomSheetConfig = z.infer<typeof RawMaterialBottomSheetConfigSchema>;
export type RawMaterialOrderedBottomSheetConfig = z.infer<typeof RawMaterialOrderedBottomSheetConfigSchema>;
export type AddRawMaterialBottomSheetConfig = z.infer<typeof AddRawMaterialBottomSheetConfigSchema>;
export type AddProductBottomSheetConfig = z.infer<typeof AddProductBottomSheetConfigSchema>;
export type AddVendorBottomSheetConfig = z.infer<typeof AddVendorBottomSheetConfigSchema>;
export type EditOrderBottomSheetConfig = z.infer<typeof EditOrderBottomSheetConfigSchema>;
export type WorkerBottomSheetConfig = z.infer<typeof WorkerBottomSheetConfigSchema>;
export type OrderShippedBottomSheetConfig = z.infer<typeof OrderShippedBottomSheetConfigSchema>;
export type OrderReachedBottomSheetConfig = z.infer<typeof OrderReachedBottomSheetConfigSchema>;
export type ProductCompletedBottomSheetConfigSchema = z.infer<typeof ProductCompletedBottomSheetConfigSchema>;
export type LaneOccupiedBottomSheetConfig = z.infer<typeof LaneOccupiedBottomSheetConfigSchema>;
export type CancelOrderBottomSheetConfig = z.infer<typeof CancelOrderBottomSheetConfigSchema>;
export type FilterBottomSheetConfig = z.infer<typeof FilterBottomSheetConfigSchema>;
export type SupervisorProductionBottomSheetConfig = z.infer<typeof SupervisorProductionBottomSheetConfigSchema>;
export type ChamberListBottomSheetConfig = z.infer<typeof ChamberListBottomSheetConfigSchema>;
export type MultipleChamberListBottomSheetConfig = z.infer<typeof MultipleChamberListBottomSheetConfigSchema>;
export type FillPackageBottomSheetConfig = z.infer<typeof FillPackageBottomSheetConfigSchema>;
export type AddPackageBottomSheetConfig = z.infer<typeof AddPackageBottomSheetConfigSchema>;
export type PackageWeightBottomSheetConfig = z.infer<typeof PackageWeightBottomSheetConfigSchema>;
export type RatingBottomSheetConfig = z.infer<typeof RatingBottomSheetConfigSchema>;
export type CountryBottomSheetConfig = z.infer<typeof CountryBottomSheetConfigSchema>;
export type StateBottomSheetConfig = z.infer<typeof StateBottomSheetConfigSchema>;
export type CityBottomSheetConfig = z.infer<typeof CityBottomSheetConfigSchema>;
export type ChooseProductBottomSheetConfig = z.infer<typeof ChooseProductBottomSheetConfigSchema>;
export type ChoosePackageBottomSheetConfig = z.infer<typeof ChoosePackageBottomSheetConfigSchema>;
export type UpcomingOrderBottomSheetConfig = z.infer<typeof UpcomingOrderBottomSheetConfigSchema>;
export type vehicleTypeBottomSheetConfig = z.infer<typeof VehicleTypeBottomSheetConfigSchema>;
export type RoleBottomSheetConfig = z.infer<typeof RoleBottomSheetConfigSchema>;
export type InProgressOrderBottomSheetConfig = z.infer<typeof InProgressOrderBottomSheetConfigSchema>;
export type ImagePreviewBottomSheetConfig = z.infer<typeof ImagePreviewBottomSheetConfigSchema>;
...
export type BottomSheetData = z.infer<(typeof bottomSheetSchemas)[BottomSheetSchemaKey]>;