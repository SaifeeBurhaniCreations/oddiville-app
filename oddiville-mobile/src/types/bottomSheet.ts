...
type sourceEnum = "add-product-package" | "add-package" | "supervisor-production";
...
export type SectionConfig =
    ...
    | {
        ...
        data: {
            searchTerm: string;
            placeholder: string;
            searchType?: "state" | "city" | "country" | "add-raw-material" | "add-product" | "add-package";
        }
    }
    | {
        ...
        data: {
            label: string;
            value: string;
            icon?: 'calendar' | 'calendarCheck' | 'database' | 'parcel' | 'location'
        }
    } | {
...
export type DataAccordianEnum = 'database' | 'user' | 'location' | 'calendar-check' | 'user-square' | 'truck' | 'truck-num' | 'clock' | 'package' | 'chamber' | 'male' | 'female' | 'money' | 'box' | 'lane' | 'color-swatch' | 'trash' | 'star' | 'calendar-year' | "paper-roll" | "bag" | "big-bag";
...
export interface TitleWithTagProps {
    data: { label?: string; tag?: { text: string; color: "red" | "green" | "blue" | "yellow"; size?: 'sm' | 'md' | 'lg' | "xl" }; rating?: number };
    color: "red" | "green" | "blue" | "yellow";
}
...
export interface InputComponentProps {
    data: { label?: string; placeholder?: string; value?: string; addon?: string; keyboardType?: TextInputProps['keyboardType']; formField?: string; };
    color: "red" | "green" | "blue" | "yellow";
}
...
export interface TitleWithDetailsCrossProps {
    data: { title: string; description?: string; details?: { label?: string; value?: string; icon?: 'database' | 'pencil', isEdit?: boolean; }; };
    color: "red" | "green" | "blue" | "yellow";
    onClose?: () => void;
}
...
export interface AddonInputComponentProps {
    ...
    conditionKey?: ConditonIdentifier,
    data: { placeholder: string; label: string; value: string; addonText: string; formField?: string; };
}
...
export const sectionComponents: Record<SectionConfig['type'], React.FC<{ data: any; color: "red" | "green" | "blue" | "yellow"; onClose?: () => void }>> = {
