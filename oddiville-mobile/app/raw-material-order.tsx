...
import {
  getLimitedMaterialNames,
  getLimitedVendorNames,
...
const RawMaterialOrderScreen = () => {
  ...
  const selectedVendor = useSelector(
    (state: RootState) => state.vendor.selectedVendors,
  );
  ...
  const onSubmit = async () => {
    ...
    const updatedVendorQuantities = updatedValues.vendorQuantities.map(
      (vendor) => {
    ...
    const newValue = {
      ...updatedValues,
      vendorQuantities: updatedVendorQuantities,
    };
              ...
              <View style={styles.headerBodyWrapper}>
                ...
                <View style={styles.body}>
                      ...
                      <View style={{ flex: 1 }}>
                        ...
                        >
                          {({ value, onChange, error }) => (
                            <Select
                              value={
                                getLimitedMaterialNames(selectedRM, 10) ||
                                "Select raw material"
                              }
                              options={[]}
                              onPress={async () => {
                  ...
                  <View style={styles.paddingH16}>
                    <Select
                      value={
                        getLimitedVendorNames(selectedVendor, 30) ||
                        "Select vendor"
                      }
                      options={[]}
