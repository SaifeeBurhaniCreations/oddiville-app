...
import { OrderBucketAdders, orderStatusHandlers } from "@/src/lookups/orderCategory";

const categorizeOrders = (orders: DispatchOrderList): {
    ...
    orders.forEach(order => {
        ...
        try {
            ...
            if (handler) {
                ...
                console.warn('Unknown order status:', order.status, 'for order:', order.id);
            }
        } catch (error) {
...
const SupervisorOrderScreen = () => {
    const { data: orderData, isFetching: ordersLoading, error, refetch } = useOrders();
    ...
    const { upComingOrders, inProgressOrders, completedOrders } = categorizedOrders;
    ...
    return (
        <View style={styles.pageContainer}>
            ...
            <View style={styles.wrapper}>
                <Tabs tabTitles={["Upcoming", "In-progress", "Completed"]} color="green" style={styles.flexGrow}>
            ...
            <Modal
                ...
                modalData={{
                    title: "Cancel order",
                    description: "Are you sure you want to cancel \u201cVikram Patel\u201d order ",
                    buttons: [
                    ...
                    extraDetails: (
                        <>
                            ...
                            <Input mask="textarea" value="" onChangeText={() => { }} placeholder="Reason" />
                        </>
                    ),
                }}
            />
...
export default SupervisorOrderScreen;
